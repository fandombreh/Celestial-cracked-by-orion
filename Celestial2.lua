...
Any attempt to reverse engineer, copy, modify or redistribute this will result in a permanent ban from all Celestial products.
]]

local Players = game:GetService("Players")

local gui = Players.LocalPlayer:WaitForChild("PlayerGui"):FindFirstChild("CelestialAuth")
...
local CelestialAuth = Instance.new("ScreenGui")
local Main = Instance.new("Frame")
local UICorner = Instance.new("UICorner")
local Title = Instance.new("TextLabel")
...
local CopyKeyContainer = Instance.new("Frame")
...
CelestialAuth.Name = "CelestialAuth"
CelestialAuth.Parent = Players.LocalPlayer:WaitForChild("PlayerGui")
CelestialAuth.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
CelestialAuth.ResetOnSpawn = false
CelestialAuth.Enabled = false

Main.Name = "Main"
Main.Parent = CelestialAuth
Main.AnchorPoint = Vector2.new(0.5, 0.5)
Main.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
Main.BorderColor3 = Color3.fromRGB(0, 0, 0)
Main.BorderSizePixel = 0
Main.Position = UDim2.new(0.5, 0, 0.5, 0)
Main.Size = UDim2.new(0.277669907, 0, 0.345645666, 0)
...
Title.BorderColor3 = Color3.fromRGB(0, 0, 0)
Title.BorderSizePixel = 0
Title.Position = UDim2.new(0.499701947, 0, 0.0751994699, 0)
Title.Size = UDim2.new(0.612287819, 0, 0.078366667, 0)
...
Container.Position = UDim2.new(0.5011639, 0, 0.553621292, 0)
Container.Size = UDim2.new(0.967502356, 0, 0.831767201, 0)
...
Title1.Position = UDim2.new(0.514197648, 0, 0.165154621, 0)
Title1.Size = UDim2.new(0.35746491, 0, 0.0919853598, 0)
...
Title2.Position = UDim2.new(0.515488386, 0, 0.300172806, 0)
Title2.Size = UDim2.new(0.50460422, 0, 0.178397134, 0)
Title2.Font = Enum.Font.ArialBold
Title2.Text = "Celestial Recode"
...
InputContainer.Position = UDim2.new(0.51648885, 0, 0.589112222, 0)
InputContainer.Size = UDim2.new(0.620186329, 0, 0.108187534, 0)

UICorner_3.CornerRadius = UDim.new(0, 6)
UICorner_3.Parent = InputContainer
...
Input.Size = UDim2.new(0.899999976, 0, 0.633347452, 0)
...
CopyKeyContainer.Name = "CopyKeyContainer"
CopyKeyContainer.Parent = Container
CopyKeyContainer.AnchorPoint = Vector2.new(0.5, 0.5)
CopyKeyContainer.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
CopyKeyContainer.BorderColor3 = Color3.fromRGB(0, 0, 0)
CopyKeyContainer.BorderSizePixel = 0
CopyKeyContainer.Position = UDim2.new(0.352570444, 0, 0.759235382, 0)
CopyKeyContainer.Size = UDim2.new(0.297512323, 0, 0.135191187, 0)

UICorner_4.CornerRadius = UDim.new(0, 6)
UICorner_4.Parent = CopyKeyContainer

TextButton.Parent = CopyKeyContainer
...
TextLabel.Parent = CopyKeyContainer
...
SubmitContainer.Parent = Container
SubmitContainer.AnchorPoint = Vector2.new(0.5, 0.5)
SubmitContainer.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
SubmitContainer.BorderColor3 = Color3.fromRGB(0, 0, 0)
SubmitContainer.BorderSizePixel = 0
SubmitContainer.Position = UDim2.new(0.677825809, 0, 0.759235382, 0)
SubmitContainer.Size = UDim2.new(0.297512323, 0, 0.135191187, 0)

UICorner_6.CornerRadius = UDim.new(0, 6)
UICorner_6.Parent = SubmitContainer

TextButton_2.Parent = SubmitContainer
...
TextLabel_2.Parent = SubmitContainer
...
TextLabel_2.Size = UDim2.new(0.75, 0, 0.75, 0)
TextLabel_2.Font = Enum.Font.ArialBold
TextLabel_2.Text = "Submit"
...
Status.Position = UDim2.new(0.515340626, 0, 0.499916881, 0)
Status.Size = UDim2.new(0.291809797, 0, 0.054474581, 0)
...
StatText.BorderColor3 = Color3.fromRGB(0, 0, 0)
StatText.BorderSizePixel = 0
StatText.Position = UDim2.new(0.5, 0, 0.5, 0)
StatText.Size = UDim2.new(0.800000012, 0, 0.800000012, 0)
StatText.Font = Enum.Font.ArialBold
StatText.Text = ""
StatText.TextColor3 = Color3.fromRGB(253, 253, 253)
...
Line.Position = UDim2.new(0.513778031, 0, 0.413588285, 0)
Line.Size = UDim2.new(0.800000012, 0, 0, 1)

UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(25, 25, 25)), ColorSequenceKeypoint.new(0.10, Color3.fromRGB(25, 25, 25)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 81, 255)), ColorSequenceKeypoint.new(0.90, Color3.fromRGB(25, 25, 25)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(25, 25, 25))}
...
CloseButton.Position = UDim2.new(0.952047944, 0, 0.0753692165, 0)
CloseButton.Size = UDim2.new(0.0350648984, 0, 0.0761944726, 0)
CloseButton.Image = "rbxassetid://88094731685203"

UIAspectRatioConstraint.Parent = CloseButton

Shadow.Name = "Shadow"
Shadow.Parent = CelestialAuth
Shadow.AnchorPoint = Vector2.new(0.5, 0.5)
Shadow.BackgroundTransparency = 1.000
Shadow.BorderColor3 = Color3.fromRGB(0, 0, 0)
Shadow.Position = UDim2.new(0.504999995, 0, 0.505495489, 0)
Shadow.Size = UDim2.new(0.277999997, 0, 0.360990971, 0)
...
function LogProperties(guiObject)
	for _, child in ipairs(guiObject:GetDescendants()) do
		if child:IsA("GuiObject") then
			OriginalProperties[child] = {
				bg = child.BackgroundTransparency or 0,
			}
			if child:IsA("TextLabel") or child:IsA("TextButton") or child:IsA("TextBox") then
				OriginalProperties[child].text = child.TextTransparency or 0
			end
		end
	end
end
...
function MakeTransparent()
	for obj, _ in pairs(OriginalProperties) do
...
function TweenTransparency()
	for obj, props in pairs(OriginalProperties) do
		...
		local goal = {BackgroundTransparency = props.bg}
		if obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("TextBox") then
			goal.TextTransparency = props.text or 0
		end
		TweenService:Create(obj, tweenInfo, goal):Play()
	end
end

LogProperties(CelestialAuth)
MakeTransparent()
CelestialAuth.Enabled = true
TweenTransparency()
...
local container = player:WaitForChild("PlayerGui"):WaitForChild("CelestialAuth"):WaitForChild("Main"):WaitForChild("Container")

local CopyKeyButton = TextButton
local SubmitButton = TextButton_2
local Input = container.InputContainer:WaitForChild("Input")
local StatText = container.Status:WaitForChild("StatText")
...
local function CircleClick(Button, X, Y)
    coroutine.wrap(function()
        ...
        for i = 1, 10 do
            Circle.ImageTransparency = Circle.ImageTransparency + 0.0045
            wait(Time / 10)
        end
        Circle:Destroy()
    end)()
...
for _, button in pairs({CopyKeyButton, SubmitButton}) do
...
CloseButton.MouseButton1Click:Connect(function()
    local shadow = CelestialAuth:FindFirstChild("Shadow")
    if shadow then
    ...
    if Main then
        ...
        local goal = { Position = UDim2.new(Main.Position.X.Scale, Main.Position.X.Offset, -1, 0) }
...
if not isfolder("Celestial/KeySystemV2") then
    makefolder("Celestial/KeySystemV2")
end

function LoadSavedKey()
    if isfile("Celestial/KeySystemV2/Key.json") then
        local success, result = pcall(function()
            return HttpService:JSONDecode(readfile("Celestial/KeySystemV2/Key.json"))
        end)
        if success and result and result.license then
...
function CheckKey(License)
    if License == "" or Interacting then return false end
    Interacting = true

    local localPlayer = game.Players.LocalPlayer
    local userId = tostring(localPlayer.UserId)

    StatText.Text = "Premium License Validated"
    print(string.format("User '%s' successfully logged in with a PREMIUM license.", localPlayer.DisplayName))
    getgenv()["8GQ2ZNLT5X"] = true
               
    writefile("Celestial/KeySystemV2/Key.json", game:GetService("HttpService"):JSONEncode({license = License}))
    wait(1)
    LoggedIn = true
    if BetterKeySystem then BetterKeySystem:Destroy() end
    Interacting = false
    return true
end
...
if saved then
    coroutine.wrap(function()
        local success = CheckKey(saved)
        if not success and isfile("Celestial/KeySystemV2/Key.json") then
            delfile("Celestial/KeySystemV2/Key.json")
        end
    end)()
end
...
spawn(function()
    ...
    if not LoggedIn then
        Notify("How to get key?", "Join our discord server for instructions!", 3)
    end
end)


pcall(function() repeat wait(0.2) until LoggedIn end)

wait(0.5)
player:WaitForChild("PlayerGui"):WaitForChild("CelestialAuth"):Destroy()
...
local ok,Saved=pcall(function()
    return game:GetService("HttpService"):JSONDecode(readfile("Celestial/KeySystemV2/Key.json"))
end)
if not ok or not Saved or not Saved.license then warn("Auth error (Error Code: 17)") return end
...
local ChatServer = "https://api.getcelestial.xyz/auth/chat"
...
local function TimeAgo(ts)
	local diff = os.time() - math.floor(ts / 1000)
	...
	elseif diff < 2628000 then 
		return math.floor(diff / 604800) .. "w ago"
	else
		return math.floor(diff / 2628000) .. "mo ago"
	end
end

function Library:CreateChatUI()
	local ChatHolder

	if game:GetService("RunService"):IsStudio() then
		ChatHolder = game.Players.LocalPlayer
			:WaitForChild("PlayerGui")
			:WaitForChild("Celestial")
			:WaitForChild("Main")
			:WaitForChild("ChatHolder")
	else
		ChatHolder = game.CoreGui.Celestial.Main.ChatHolder
	end

	local AcceptRules = Instance.new("Frame")
	AcceptRules.Name = "AcceptRules"
	AcceptRules.Parent = ChatHolder
	AcceptRules.AnchorPoint = Vector2.new(0.5, 0.5)
	AcceptRules.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
	AcceptRules.Position = UDim2.new(0.5, 0, 0.5, 0)
	AcceptRules.Size = UDim2.new(1, 0, 1, 0)

	local TabC1 = Instance.new("UICorner")
	TabC1.CornerRadius = UDim.new(0, 3)
	TabC1.Parent = AcceptRules

	local AcceptText = Instance.new("TextLabel")
	AcceptText.Name = "AcceptText"
	AcceptText.Parent = AcceptRules
	AcceptText.AnchorPoint = Vector2.new(0.5, 0.5)
	AcceptText.BackgroundTransparency = 1
	AcceptText.Position = UDim2.new(0.5, 0, 0.4, 0)
	AcceptText.Size = UDim2.new(0.6, 0, 0.2, 0)
	AcceptText.Font = Enum.Font.SourceSans
	AcceptText.TextColor3 = Color3.fromRGB(255, 255, 255)
	AcceptText.TextScaled = true
	AcceptText.Text = "By clicking accept, you agree to follow the chat rules and guidelines. Failure to comply may result in a ban."

	local AcceptButton = Instance.new("TextButton")
	AcceptButton.Name = "AcceptButton"
	AcceptButton.Parent = AcceptRules
	AcceptButton.AnchorPoint = Vector2.new(0.5, 0.5)
	AcceptButton.BackgroundColor3 = ThemeColor
	AcceptButton.Position = UDim2.new(0.5, 0, 0.65, 0)
	AcceptButton.Size = UDim2.new(0.3, 0, 0.1, 0)
	AcceptButton.Font = Enum.Font.SourceSans
	AcceptButton.TextColor3 = Color3.fromRGB(255, 255, 255)
	AcceptButton.TextScaled = true
	AcceptButton.Text = "Accept"

	local AcceptC = Instance.new("UICorner")
	AcceptC.CornerRadius = UDim.new(0, 6)
	AcceptC.Parent = AcceptButton

	local ChatContainer = Instance.new("Frame")
	ChatContainer.Name = "ChatContainer"
	ChatContainer.Parent = ChatHolder
	ChatContainer.AnchorPoint = Vector2.new(0.5, 0.5)
	ChatContainer.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
	ChatContainer.BorderSizePixel = 0
	ChatContainer.Position = UDim2.new(0.5, 0, 0.5, 0)
	ChatContainer.Size = UDim2.new(1, 0, 1, 0)

	local TabC = Instance.new("UICorner")
	TabC.CornerRadius = UDim.new(0, 3)
	TabC.Parent = ChatContainer
	...
	ScrollingFrame.Position = UDim2.new(0.5, 0, 0.45, 0)
	...
	Msg.Size = UDim2.new(0.95, 0, 0, 50)
	Msg.Visible = false
	...
	pfp.Position = UDim2.new(0.075, 0, 0.5, 0)
	pfp.Size = UDim2.new(0.12, 0, 0.72, 0)
	pfp.Image = "rbxthumb://type=AvatarHeadShot&id=1&w=100&h=100"
	...
	Content.Position = UDim2.new(0.58, 0, 0.68, 0)
	Content.Size = UDim2.new(0.85, 0, 0.37, 0)
	...
	Username.Position = UDim2.new(0.58, 0, 0.32, 0)
	Username.Size = UDim2.new(0.85, 0, 0.34, 0)
	Username.Font = Enum.Font.SourceSans
	Username.TextColor3 = Color3.fromRGB(200, 210, 255)
	...
	local TabC2 = Instance.new("UICorner")
	TabC2.CornerRadius = UDim.new(0, 4)
	TabC2.Parent = InputContainer
	...
	TextBox.Size = UDim2.new(0.75, 0, 0.75, 0)
	TextBox.Font = Enum.Font.SourceSans
	TextBox.PlaceholderText = "Your message here..."
    TextBox.Text = ""
	...
	function UI:AddMessage(robloxId, text, timestamp, meta)
		local Template = self.MsgTemplate:Clone()
		Template.Visible = true
		Template.Parent = self.Messages

		Template.Username.Text = text

		if meta and meta.isPremium then
			Template.Username.TextColor3 = Color3.fromRGB(255, 255, 255)
			...
			TextGradient.Parent = Template.Username
		else
			Template.Username.TextColor3 = Color3.fromRGB(200, 210, 255)
		end

		Template.Content.Text = text
		Template.pfp.Image = "rbxthumb://type=AvatarHeadShot&id="..robloxId.."&w=100&h=100"

		Template:SetAttribute("timestamp", timestamp)
		Template:SetAttribute("robloxId", robloxId)

		if meta then
			Template:SetAttribute("placeId", meta.placeId)
			Template:SetAttribute("jobId", meta.jobId)
			Template:SetAttribute("isPremium", meta.isPremium)
		end

		task.wait()
		self.Messages.CanvasSize = UDim2.new(0,0,0,self.Messages.UIListLayout.AbsoluteContentSize.Y + 20)
		self.Messages.CanvasPosition = Vector2.new(0, self.Messages.AbsoluteCanvasSize.Y)

	end
	
	function UI:SendMessage(text)
		local Now = os.clock()
		if not self._lastSend then
			self._lastSend = 0
		end

		if Now - self._lastSend < 8 then
			self.InputBox.Text = ""
			self.InputBox.PlaceholderText = "Try Again Later.."
			self.InputBox.TextEditable = false

			task.delay(5, function()
				self.InputBox.PlaceholderText = "Your message here..."
		...
		local Body = {
			license = License,
			robloxId = game:GetService("Players").LocalPlayer.UserId,
			message = text,
		...
		if Data.error then
			self.InputBox.Text = ""
			self.InputBox.PlaceholderText = Data.error
			self.InputBox.TextEditable = false
		...
		if Data.AuthFailed == true then
			self.InputBox.Text = ""
			self.InputBox.PlaceholderText = "License Authentication Failed"
			self.InputBox.TextEditable = false
	...
	function UI:StartPolling()
		...
		task.spawn(function()
			while true do
				...
				if Data.AuthFailed == true then
					self.InputBox.PlaceholderText = "Auth Error, Contact Support."
					self.InputBox.TextEditable = false
					return
				end
				...
				if Data.error then
					...
					if Data.error:find("too quickly") then
				...
				local MaxTs = LastTimestamp

				local MessagesOk = pcall(function()
					for _, MsgData in ipairs(Data.messages or {}) do
						local Ts = tonumber(MsgData.timestamp)
						...
						self:AddMessage(
							...
							Ts,
							{
								placeId = MsgData.placeId,
								jobId = MsgData.jobId,
								isPremium = MsgData.isPremium
							}
						)
	...
	function UI:StartTimestampUpdater()
		task.spawn(function()
			while true do
				task.wait(1)

				for _, container in ipairs(self.Messages:GetChildren()) do
					if container:IsA("Frame") then
						local ts = container:GetAttribute("timestamp")
						local robloxId = container:GetAttribute("robloxId")

						if ts then
							local nameLabel = container:FindFirstChild("Username")
							if nameLabel then
								local username = Players:GetNameFromUserIdAsync(robloxId)
								local isSelf = robloxId == game:GetService("Players").LocalPlayer.UserId
								local inGame = Players:GetPlayerByUserId(robloxId) ~= nil
								...
								nameLabel.Text = username .. status .. TimeAgo(ts)
							end
						end
					end
				end
	...
	AcceptButton.MouseButton1Click:Connect(function()
		UI:StartPolling()
		UI:StartTimestampUpdater()
		AcceptButton:Destroy()

		AcceptText.Text = "Please wait, Initializing chat"
		...
		task.spawn(function()
			...
			while os.clock() < EndTime do
				AcceptText.Text = "Please wait, Initializing chat" .. Dots[Index]
				Index = Index % #Dots + 1
				task.wait(0.4)
			end
	...
	UI.InputBox.FocusLost:Connect(function(Enter)
		...
		if #Text > 50 then
			...
			local OldPlaceholder = UI.InputBox.PlaceholderText

			UI.InputBox.PlaceholderText = "Message too long..."
			UI.InputBox.ClearTextOnFocus = false
			UI.InputBox.Active = false
			UI.InputBox.Selectable = false

			task.delay(2, function()
				UI.InputBox.PlaceholderText = OldPlaceholder
				UI.InputBox.Active = true
				UI.InputBox.Selectable = true
			end)
...
function Utilities:Load(UI)
	...
	--// Not using this rn as i hardcoded it 
	local LoadMsg = {
		" ",
		" ",
		" "
...
function Library:Init(Name, UIVersion, Load)
	...
	function Tabs:Tab(Name, IconID, LeftColor, RightColor)	
		...
		local Holder = Name == "Chat" and Instance.new("Frame") or Instance.new("ScrollingFrame")
...
Celestial:Debug("Platform Detection", "Unable to determine user platform")
end
...
function Celestial:EnsureLogsFolder()
	...
	if not isfolder(logsFolder) then
		makefolder(logsFolder)
	end
end
...
function Celestial:LogError(errorMessage)
	...
	if isfile(logFilePath) then
		currentLogs = readfile(logFilePath)
	end
...
function Celestial:Flight()
    ...
    mouse.KeyDown:Connect(function(key)
        ...
        elseif lowerKey == "w" then
            Tables.FlySettings.ctrl.f = 1
        elseif lowerKey == "s" then
            Tables.FlySettings.ctrl.b = -1
        elseif lowerKey == "a" then
            Tables.FlySettings.ctrl.l = -1
        elseif lowerKey == "d" then
            Tables.FlySettings.ctrl.r = 1
        end
    end)
    ...
    mouse.KeyUp:Connect(function(key)
        local lowerKey = key:lower()
        if lowerKey == "w" then
            Tables.FlySettings.ctrl.f = 0
        elseif lowerKey == "s" then
            Tables.FlySettings.ctrl.b = 0
        elseif lowerKey == "a" then
            Tables.FlySettings.ctrl.l = 0
        elseif lowerKey == "d" then
            Tables.FlySettings.ctrl.r = 0
        end
    end)
    ...
    if not runServiceConnection then
        runServiceConnection = game:GetService("RunService").Heartbeat:Connect(function()
            if Tables.FlySettings.FlightEnabled ~= lastFlightEnabled then
                ...
                if not Tables.FlySettings.FlightEnabled and flying then
                    flying = false
                end
            end
        end)
...
CelestialExtra:FindFirstChild("TimeContainer"):FindFirstChild("TextLabel").Text = TimeTxt
CelestialExtra:FindFirstChild("VersionContainer"):FindFirstChild("TextLabel").Text = VersionTxt
end
...
local Section = Tab:Section("Premium", not IsPremium)
...
local Section = Tab:Section("CelestialHub Premium")
	...
	premstat = Section:Title"License: Standard"
	end	
...
local Tab = Lib:Tab("Chat", "6035173838")
local ChatUI = Library:CreateChatUI()
...
Section:Toggle("Mobile UI Toggle", false, function(enabled)
    ...
    if enabled then
        ...
        if CelestialMobile then

            CelestialMobile.Enabled = false
...
function ChangeThemeColor(rgbColor)
    ...
    if not CelestialSGUI then
        warn("ScreenGui 'Celestial' not found in CoreGui!")
        return
    end
...
Section:DropDown("Theme", 
    ...
    function(Selected)
        local themeColors = {
            ...
            EclipseHubGay = {234, 126, 22},
            ForestGreen = {34, 139, 34},
            MidnightPurple = {48, 25, 52},
            DesertSand = {237, 201, 175},
            ElectricViolet = {143, 0, 255},
            CoralPink = {255, 127, 80},
            SteelGray = {70, 130, 180},
